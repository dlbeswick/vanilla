package org.farng.mp3.id3.test;
...
public class AbstractMP3Tag extends TestCase {
    ...
    public void testID3v2_2() {
        ...
        //assertEquals(tag, newTag); dbeswick: it looks like this test is defeated by TODOs in ID3v2_4Frame(final AbstractID3v2Frame frame). 2.2's TYER should be converted to 2.4's TDRC. 
        assertEquals(newTag.getSongTitle(), tag.getSongTitle());
        assertEquals(newTag.getLeadArtist(), tag.getLeadArtist());
        assertEquals(newTag.getAlbumTitle(), tag.getAlbumTitle());
        //assertEquals(newTag.getYearReleased(), tag.getYearReleased());  dbeswick: it looks like this test is defeated by TODOs in ID3v2_4Frame(final AbstractID3v2Frame frame). 2.2's TYER should be converted to 2.4's TDRC.
        assertEquals(newTag.getSongComment(), tag.getSongComment());
        assertEquals(newTag.getSongGenre(), tag.getSongGenre());
        assertEquals(newTag.getTrackNumberOnAlbum(), tag.getTrackNumberOnAlbum());
        assertEquals(newTag.getSongLyric(), tag.getSongLyric());
    ...
    public void testID3v2_3() {
        ...
        //assertEquals(tag, newTag);  dbeswick: it looks like this test is defeated by TODOs in ID3v2_4Frame(final AbstractID3v2Frame frame). 2.3's TYER should be converted to 2.4's TDRC.
        assertEquals(newTag.getSongTitle(), tag.getSongTitle());
        assertEquals(newTag.getLeadArtist(), tag.getLeadArtist());
        assertEquals(newTag.getAlbumTitle(), tag.getAlbumTitle());
        //assertEquals(newTag.getYearReleased(), tag.getYearReleased());  dbeswick: it looks like this test is defeated by TODOs in ID3v2_4Frame(final AbstractID3v2Frame frame). 2.3's TYER should be converted to 2.4's TDRC.
        assertEquals(newTag.getSongComment(), tag.getSongComment());
        assertEquals(newTag.getSongGenre(), tag.getSongGenre());
        assertEquals(newTag.getTrackNumberOnAlbum(), tag.getTrackNumberOnAlbum());
        assertEquals(newTag.getSongLyric(), tag.getSongLyric());
