...
import org.kreed.vanilladev.Song.NotPopulatedException;
...
public final class PlaybackService extends Service implements Handler.Callback, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, SharedPreferences.OnSharedPreferenceChangeListener, SongTimeline.Callback {	
	 ...
	 */
	public static final String ACTION_TOGGLE_PLAYBACK = "org.kreed.vanilladev.action.TOGGLE_PLAYBACK";
	/**
	 * Action for startService: toggle playback on/off.
	 *
	 ...
	 * instead.
	 */
	public static final String ACTION_TOGGLE_PLAYBACK_DELAYED = "org.kreed.vanilladev.action.TOGGLE_PLAYBACK_DELAYED";
	/**
	 * Action for startService: advance to the next song.
	 */
	public static final String ACTION_NEXT_SONG = "org.kreed.vanilladev.action.NEXT_SONG";
	/**
	 * Action for startService: advance to the next song.
	 *
	 ...
	 * instead.
	 */
	public static final String ACTION_NEXT_SONG_DELAYED = "org.kreed.vanilladev.action.NEXT_SONG_DELAYED";
	/**
	 * Action for startService: advance to the next song.
	 *
	 ...
	 * when this is called.
	 */
	public static final String ACTION_NEXT_SONG_AUTOPLAY = "org.kreed.vanilladev.action.NEXT_SONG_AUTOPLAY";
	/**
	 * Action for startService: go back to the previous song.
	 */
	public static final String ACTION_PREVIOUS_SONG = "org.kreed.vanilladev.action.PREVIOUS_SONG";
	/**
	 * Action for startService: go back to the previous song.
	 *
	 ...
	 * when this is called.
	 */
	public static final String ACTION_PREVIOUS_SONG_AUTOPLAY = "org.kreed.vanilladev.action.PREVIOUS_SONG_AUTOPLAY";
	/**
	 ...
	 */
	public static final String ACTION_PLAY_ITEMS = "org.kreed.vanilladev.action.PLAY_ITEMS";
	/**
	 * Intent action that may be invoked through startService.
	 *
	 ...
	 * song, album, or artist.
	 */
	public static final String ACTION_ENQUEUE_ITEMS = "org.kreed.vanilladev.action.ENQUEUE_ITEMS";
	/**
	 ...
	 */
	public static final String ACTION_FINISH_ENQUEUEING = "org.kreed.vanilladev.action.FINISH_ENQUEUEING";

	public static final String EVENT_REPLACE_SONG = "org.kreed.vanilladev.event.REPLACE_SONG";
	public static final String EVENT_CHANGED = "org.kreed.vanilladev.event.CHANGED";
	public static final String EVENT_INITIALIZED = "org.kreed.vanilladev.event.INITIALIZED";
	...
	/**
	 * This constant should be incremented if a change is made to preferences that would
	 * cause any part of the code to fail when loading old preference data. 
	 */
	private static final int PREFERENCES_VERSION = 1;
	private static final String PREFERENCES_VERSION_KEY = "playbackservice_preferences_version";
	...
	{
		return ContextApplication.getContext().getSettings();
	}
	...
	/**
	 * Load the initial values for preferences, and perform any versioning work to convert preference
	 * data from old version formats.
	 */
	private void initializePreferences()
	{
		...
		// dbeswick: I encountered problems loading preferences when I renamed the Preference class used
		// for this data. A ClassCastException is thrown when the old settings are loaded. I added the
		// versioning code in case this situation happens in future.
		try {
			version = settings.getInt(PREFERENCES_VERSION_KEY, 0);
		} catch (ClassCastException e) {
			Log.w(
				getClass().getName(), 
				String.format("Exception while retrieving preference version key, setting preference version to 0 (%s)", e.getClass().getName())
			);
		}
		...
		if (version < 1) {
			...
			editor.remove("replaygain_max_boost");
			editor.remove("replaygain_no_data_attenuation");
			editor.commit();
			PreferenceManager.setDefaultValues(getApplicationContext(), R.xml.preferences, true);
		}
		
		mReplayGainMaxBoostDecibels = AmplitudeGain.inDecibels(
				Float.valueOf(settings.getString("replaygain_max_boost", "3.0"))
			);
		
		mReplayGainNoDataAttenuationDecibels = AmplitudeGain.inDecibels(
				Float.valueOf(settings.getString("replaygain_no_data_attenuation", "-10"))
			);
		
		// Update the perferences version number.
		SharedPreferences.Editor editor = settings.edit();
		editor.putInt(PREFERENCES_VERSION_KEY, PREFERENCES_VERSION);
		editor.commit();
	}
	...
	public boolean handleMessage(Message message)
	{
		...
		case CREATE:
			...
			break;
		case POST_CREATE:
			mHeadsetPause = getSettings().getBoolean("headset_pause", true);
			setupReceiver();
